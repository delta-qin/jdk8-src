package com.deltaqin.socket.s02_tcp;
...
public class Server {
    ...
    private static ServerSocket createServerSocket() throws IOException {
        ...
        //new ServerSocket().bind(new InetSocketAddress(Inet4Address.getLocalHost(), PORT), 50);

        // 等效于上面的方案，等待队列设置为50个，而不是连接限制为50个。客户端触发异常
