...
public class Collections {
     ...
     *
     * 注意下面的泛型定义了集合内的元素必须是 继承 Object 并且实现 Comparable 的接口，因为比较的时候要使用compareTo方法
     * 不需要传入外部排序器
     *
     * 泛型直接定义了必须实现 Comparable 接口，在编译的时候就可告诉使用者，当前类没有实现 Comparable 接口，使用起来很友好；
     */
    ...
    static class SynchronizedCollection<E> implements Collection<E>, Serializable {
        ...
        final Object mutex;     // Object on which to synchronize 加的锁是不可变的
